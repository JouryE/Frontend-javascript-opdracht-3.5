...
// ==========================================
const year = ['1991', '2001', '2011', '2021'];
console.log(year);
...
// ==========================================
const hobbies = ['Mijn gezin', 'Gamen','Programmeren Front End'];
console.log(hobbies);
...
// ==========================================
const numbersUnderTen = [3, 4, 5, 7, 2];
console.log(numbersUnderTen[0]);
...
// ==========================================
const numbersAboveTen = [21, 22, 23, 25, 25];
console.log(numbersAboveTen);

numbersAboveTen[3] = 24;
console.log(numbersAboveTen);
